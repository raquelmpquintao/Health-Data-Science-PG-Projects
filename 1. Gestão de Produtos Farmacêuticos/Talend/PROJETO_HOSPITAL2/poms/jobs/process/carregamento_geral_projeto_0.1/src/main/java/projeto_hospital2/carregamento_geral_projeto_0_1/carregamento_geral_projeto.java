...
package projeto_hospital2.carregamento_geral_projeto_0_1;
...
/**
 * Job: carregamento_geral_projeto Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class carregamento_geral_projeto implements TalendJob {
	...
	private final String jobName = "carregamento_geral_projeto";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					carregamento_geral_projeto.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(carregamento_geral_projeto.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				projeto_hospital2.carregamento_truncate_staging_projeto_0_1.carregamento_truncate_staging_projeto childJob_tRunJob_1 = new projeto_hospital2.carregamento_truncate_staging_projeto_0_1.carregamento_truncate_staging_projeto();
				// pass DataSources
	...
	public void tRunJob_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				projeto_hospital2.carregamento_produtofarmaceutico_0_1.carregamento_ProdutoFarmaceutico childJob_tRunJob_2 = new projeto_hospital2.carregamento_produtofarmaceutico_0_1.carregamento_ProdutoFarmaceutico();
				// pass DataSources
	...
	public void tRunJob_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				projeto_hospital2.carregamento_entidaderesponsavel_0_1.carregamento_EntidadeResponsavel childJob_tRunJob_4 = new projeto_hospital2.carregamento_entidaderesponsavel_0_1.carregamento_EntidadeResponsavel();
				// pass DataSources
	...
	public void tRunJob_5Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				projeto_hospital2.carregamento_servico_0_1.carregamento_servico childJob_tRunJob_5 = new projeto_hospital2.carregamento_servico_0_1.carregamento_servico();
				// pass DataSources
	...
	public void tRunJob_6Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				projeto_hospital2.carregamento_utente_0_1.carregamento_utente childJob_tRunJob_6 = new projeto_hospital2.carregamento_utente_0_1.carregamento_utente();
				// pass DataSources
	...
	public void tRunJob_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				projeto_hospital2.carregamento_tfdispensaprodutos_0_1.carregamento_TFDispensaProdutos childJob_tRunJob_3 = new projeto_hospital2.carregamento_tfdispensaprodutos_0_1.carregamento_TFDispensaProdutos();
				// pass DataSources
	...
	public void tRunJob_10Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				projeto_hospital2.carregamento_dim_utente_0_1.carregamento_dim_utente childJob_tRunJob_10 = new projeto_hospital2.carregamento_dim_utente_0_1.carregamento_dim_utente();
				// pass DataSources
	...
	public void tRunJob_9Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				projeto_hospital2.carregamento_dim_servico_0_1.carregamento_dim_servico childJob_tRunJob_9 = new projeto_hospital2.carregamento_dim_servico_0_1.carregamento_dim_servico();
				// pass DataSources
	...
	public void tRunJob_7Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				projeto_hospital2.carregamento_dim_entidaderesponsavel_0_1.carregamento_dim_entidaderesponsavel childJob_tRunJob_7 = new projeto_hospital2.carregamento_dim_entidaderesponsavel_0_1.carregamento_dim_entidaderesponsavel();
				// pass DataSources
	...
	public void tRunJob_8Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				projeto_hospital2.carregamento_dim_produtofarmaceutico_0_1.carregamento_dim_produtofarmaceutico childJob_tRunJob_8 = new projeto_hospital2.carregamento_dim_produtofarmaceutico_0_1.carregamento_dim_produtofarmaceutico();
				// pass DataSources
	...
	public void tRunJob_11Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				projeto_hospital2.carregamento_facto_dispensaprodutos_0_1.carregamento_facto_dispensaprodutos childJob_tRunJob_11 = new projeto_hospital2.carregamento_facto_dispensaprodutos_0_1.carregamento_facto_dispensaprodutos();
				// pass DataSources
	...
	public static void main(String[] args) {
		final carregamento_geral_projeto carregamento_geral_projetoClass = new carregamento_geral_projeto();

		int exitCode = carregamento_geral_projetoClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = carregamento_geral_projeto.class.getClassLoader().getResourceAsStream(
					"projeto_hospital2/carregamento_geral_projeto_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = carregamento_geral_projeto.class.getClassLoader()
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : carregamento_geral_projeto");
		}
 ...
 * 16 February 2024 at 19:51:49 GMT
 ************************************************************************************************/